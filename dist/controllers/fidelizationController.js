...
exports.FidelizationController = void 0;
class FidelizationController {
    fidelizationService;
    constructor(fidelizationService) {
        this.fidelizationService = fidelizationService;
    }
    /**
     * POST /api/v1/customers/:id/points/accumulate
     * Acumular puntos por compra realizada.
     */
    accumulate = async (req, res) => {
        try {
            const { id } = req.params;
...
exports.FidelizationController = FidelizationController;
