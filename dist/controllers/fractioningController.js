...
exports.FractioningController = void 0;
class FractioningController {
    fractioningService;
    constructor(fractioningService) {
    ...
    execute = async (req, res) => {
        try {
            const { rawMaterialId, finalProductId, inputQtyKg, actualOutputUnits, wasteReason, rawMaterialBatch, generatedBatch, expirationDate, operatorName, notes } = req.body;
...
exports.FractioningController = FractioningController;
