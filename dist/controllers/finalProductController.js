...
class FinalProductController {
    ...
    create = async (req, res) => {
        try {
            const { rawMaterialId, code, barcode, name, unitWeightGrams, netContentLabel, currentStock, minStock, price, ingredients, dietaryBadgeCodes, defaultExpirationDays } = req.body;
