...
class FinanceController {
    ...
    getExpenseSummary = async (req, res) => {
        try {
            ...
            const summary = await this.financeService.getExpenseSummary(startDate ? String(startDate) : undefined, endDate ? String(endDate) : undefined);
            res.json({
                status: 'SUCCESS',
                data: summary
            });
     ...
     */
    getAllPricingStructures = async (req, res) => {
        try {
     ...
     */
    getPricingStructureByProductId = async (req, res) => {
        try {
    ...
    calculatePreview = async (req, res) => {
        try {
            const { productId, productSku, productName, unitOfMeasure, rawMaterialCost, packagingLabelCost, laborCost, allocatedFixedCosts, taxPercentage, channels } = req.body;
     ...
     */
    savePricingStructure = async (req, res) => {
        try {
            const { productId, productSku, productName, unitOfMeasure, rawMaterialCost, packagingLabelCost, laborCost, allocatedFixedCosts, taxPercentage, channels } = req.body;
     ...
     */
    allocateFixedCosts = async (req, res) => {
        try {
