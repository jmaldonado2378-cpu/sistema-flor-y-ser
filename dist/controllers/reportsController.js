...
class ReportsController {
     ...
     */
    getTicketPromedio = async (req, res) => {
        try {
     ...
     */
    getStarProductsByDiet = async (req, res) => {
        try {
            const dietaryCode = req.query.dietaryCode || 'VEGAN';
     ...
     */
    getRepurchaseRate = async (req, res) => {
        try {
    ...
    getInactiveCustomers = async (req, res) => {
        try {
            const daysRangeStr = req.query.daysRange;
     ...
     */
    getDailyCashAudit = async (req, res) => {
        try {
     ...
     */
    getCurrentAccountsBalance = async (req, res) => {
        try {
