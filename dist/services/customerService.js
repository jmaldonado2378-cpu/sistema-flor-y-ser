...
class CustomerService {
    ...
    inMemoryCustomers = [
        {
            ...
            segment: customer_1.CustomerSegment.FRECUENTE,
            pointsBalance: 1250,
        ...
        },
        {
            ...
            segment: customer_1.CustomerSegment.VIP,
            pointsBalance: 3400,
        ...
        },
        {
            ...
            segment: customer_1.CustomerSegment.OCASIONAL,
            pointsBalance: 450,
     ...
     */
    calculateSegment(totalSpent, totalOrders) {
        if (totalSpent >= 150000 || totalOrders >= 12) {
            return customer_1.CustomerSegment.VIP;
        }
        if (totalSpent >= 80000) {
            return customer_1.CustomerSegment.MAYORISTA;
        }
        if (totalOrders >= 4) {
            return customer_1.CustomerSegment.FRECUENTE;
        }
        return customer_1.CustomerSegment.OCASIONAL;
    }
    /**
    ...
    async createCustomer(dto) {
      ...
      `;
            const customerValues = [
                ...
                dto.birthDate || null,
                dto.preferredChannel || customer_1.AcquisitionChannel.LOCAL,
            ...
            if (dto.dietaryProfileIds && dto.dietaryProfileIds.length > 0) {
                for (const rawProfileId of dto.dietaryProfileIds) {
                    ...
                    for (const pId of candidateIds) {
                        try {
                            await client.query(`INSERT INTO customer_dietary_profiles (customer_id, dietary_profile_id, specific_notes) VALUES ($1, $2, $3)
                 ON DUPLICATE KEY UPDATE specific_notes = VALUES(specific_notes);`, [insertedId, pId, specificNotes]);
                            break;
                        }
                        catch {
    ...
    createCustomerInMemory(dto) {
        ...
        const dietaryProfiles = (dto.dietaryProfileIds || []).map(id => ({
            id,
            code: 'CUSTOM_DIET',
        ...
        const newCustomer = {
            ...
            preferredChannel: dto.preferredChannel || customer_1.AcquisitionChannel.LOCAL,
            segment: customer_1.CustomerSegment.OCASIONAL,
            pointsBalance: 0,
    ...
    `;
        try {
          ...
          `;
                    ...
                    dietaryProfiles = dietaryRes.rows.map((row) => ({
                        id: row.id,
                        code: row.code,
                        name: row.name,
          ...
          `;
                ...
                return {
                    ...
                    preferredChannel: customer.preferred_channel || customer_1.AcquisitionChannel.LOCAL,
                    segment,
    ...
    async searchCustomers(filters = {}) {
      ...
      `;
        ...
        if (filters.search) {
            ...
            result = result.filter(c => c.firstName.toLowerCase().includes(q) ||
        ...
        try {
            ...
            if (dto.dietaryProfileIds !== undefined) {
                ...
                for (const rawProfileId of dto.dietaryProfileIds) {
                    ...
                    for (const pId of candidateIds) {
                        try {
                            await this.db.query(`INSERT INTO customer_dietary_profiles (customer_id, dietary_profile_id, specific_notes) VALUES ($1, $2, $3)
                 ON DUPLICATE KEY UPDATE specific_notes = VALUES(specific_notes);`, [customerId, pId, specificNotes]);
                            break;
                        }
                        catch { }
                    }
