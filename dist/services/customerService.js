      ...
      `;
            ...
            if (dto.dietaryProfileIds && dto.dietaryProfileIds.length > 0) {
                for (const profileId of dto.dietaryProfileIds) {
                    ...
                    await client.query(`INSERT INTO customer_dietary_profiles (customer_id, dietary_profile_id, specific_notes) VALUES ($1, $2, $3);`, [customerId, profileId, specificNotes]);
                }
            }
    ...
    `;
        try {
            ...
            if (dto.dietaryProfileIds !== undefined) {
                ...
                for (const profileId of dto.dietaryProfileIds) {
                    const specificNotes = dto.dietaryNotes && dto.dietaryNotes[profileId] ? dto.dietaryNotes[profileId] : null;
                    await this.db.query(`INSERT INTO customer_dietary_profiles (customer_id, dietary_profile_id, specific_notes) VALUES ($1, $2, $3);`, [customerId, profileId, specificNotes]);
                }
            }
            return await this.getUnifiedProfile(customerId);
        }
